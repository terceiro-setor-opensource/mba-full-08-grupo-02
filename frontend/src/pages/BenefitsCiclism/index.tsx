...
const benefits = [
  {
    ...
    description:
      'Pedalar regularmente pode reduzir o risco de doenças cardiovasculares, como hipertensão, ataques cardíacos e derrames.',
    iconColor: 'red.500',
  },
  {
    icon: <FaWeight />,
    ...
    description:
      'O ciclismo é eficaz para queimar calorias e ajudar na perda ou manutenção de peso saudável.',
    iconColor: 'gray.500',
  },
  {
    icon: <FaDumbbell />,
    ...
    description:
      'Fortalece os músculos das pernas, incluindo quadríceps, isquiotibiais, panturrilhas e glúteos.',
